            ...
            JSON.parse(localStorage.getItem("user"))?.email
               ? (
                  <Link to={"/"} onClick={handleSignOut}
                     ...
                     <div className="justify-center text-xs w-full whitespace-nowrap overflow-hidden px-1 flex bg-yellow-400 group-hover:bg-slate-900 group-hover:text-yellow-400 transition capitalize border-b">
                        {JSON.parse(localStorage.getItem("user"))?.name}
                     </div>

                     <div className="flex w-full items-center justify-center gap-2 px-2 text-black bg-yellow-400 ">
